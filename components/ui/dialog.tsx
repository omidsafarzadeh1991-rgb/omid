  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showClose && (
          <DialogPrimitive.Close className="absolute top-4 left-4 rounded-md opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
            <X className="size-4" />
