  ...
  return (
    <form action={action} dir="rtl" className="flex flex-col gap-2 sm:flex-row">
      ...
      <input
        ...
        dir="ltr"
        className="w-full min-w-0 rounded-lg border border-slate-300 px-3 py-2 text-sm ltr:text-left focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500 sm:w-48"
      />
